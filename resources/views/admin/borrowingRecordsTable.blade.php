...
<body class="bg-[#FCF1F1] text-gray-800 flex h-screen">
    ...
    <div class="flex-1 flex flex-col ml-0 overflow-auto">
        ...
        <div class="p-6 flex-1">
            ...
            <!-- Search Bar -->
            <form action="{{ route('admin.borrowingRecordsTable') }}" method="GET" class="mb-4">
                <input type="text" name="search" placeholder="Search borrowing reco..." class="p-2 border border-gray-300 rounded-lg" >
