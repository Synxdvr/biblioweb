...
<head>
    ...
    @vite('resources/js/AdminBookCategoriesTable.js')
    <style>
        body {
...
<body class="bg-[#FCF1F1] text-gray-800 flex h-screen">
    ...
    <!-- Main Content -->
     <div class="flex-1 flex flex-col ml-0 overflow-auto">
        ...
        <div class="p-6 flex-1">
            ...
            <!-- Search Bar -->
            <form action="{{ route('admin.bookCategoriesTable') }}" method="GET" class="mb-4">
        ...
        <div id="addCategoryModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
                ...
                <form action="{{ route('admin.bookCategories.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
    ...
    <script>
        ...
        function openEditModal(category) {
            ...
            document.getElementById('editCategoryForm').action = `/admin/bookCategories/${category.category_id}`;
            toggleModal('editCategoryModal');
        }

        function openDeleteModal(categoryId) {
            document.getElementById('deleteCategoryForm').action = `/admin/bookCategories/${categoryId}`;
